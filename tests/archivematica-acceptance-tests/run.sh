...
STATE_FILE="${STATE_FILE:-${SUITE_DIR}/artifacts/archivematica_vm.env}"
REQUIREMENTS_FILE="${SUITE_DIR}/requirements.yml"
PLAYBOOK_FILE="${SUITE_DIR}/playbook.yml"
INVENTORY_FILE="${SUITE_DIR}/inventory.ini"

export STATE_FILE
export VM_NAME="${VM_NAME:-archivematica-acceptance}"
export SSH_FORWARD_PORT="${SSH_FORWARD_PORT:-2222}"
export FORWARD_PORTS="${FORWARD_PORTS:-"2222:22 8000:80 8001:8000"}"
